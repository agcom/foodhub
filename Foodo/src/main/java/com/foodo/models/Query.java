...
public class Query {
    ...
    public class Row {
        ...
        public ObjectHolder getObjectHolder(int columnIndex) throws SQLException {
            ...
            if(listIndex == -1) throw new SQLException("Defined column index " + columnIndex + " not found in the query");
        ...
        public ObjectHolder getObjectHolder(String columnName) throws SQLException {
            ...
            if(listIndex == -1) throw new SQLException("Defined column name '" + columnName + "' not found in the query");
