...
public class Order {
	...
	private final int id; //order code unique
	private final String email; //user ordered this order
	private final ArrayList<OrderItem> items = new ArrayList<>(); //items ordered
	private final Timestamp date; //date and time order submitted
