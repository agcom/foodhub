...
public class Query {
	...
	public class Row {
		...
		public ObjectHolder getObjectHolder(int columnIndex) {
			...
			if (listIndex == -1)
				throw new QueryException("Defined column index " + columnIndex + " not found in the query");
		...
		public ObjectHolder getObjectHolder(String columnName) {
			...
			if (listIndex == -1)
				throw new QueryException("Defined column name '" + columnName + "' not found in the query");
