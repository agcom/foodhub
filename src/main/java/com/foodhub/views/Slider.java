...
public class Slider extends StackPane {
	...
	private final ObservableList<Region> nodes = FXCollections.observableArrayList();
	private final IntegerProperty currentSlideIndex = new SimpleIntegerProperty(this, "currentSlideIndex", -1);
	private final ObjectProperty<Duration> duration = new SimpleObjectProperty<>(this, "duration", Duration.seconds(0.2));
	private final TranslateTransition inSlide = new TranslateTransition(getDuration());
	private final TranslateTransition outSlide = new TranslateTransition(getDuration());
	private final ObjectProperty<Interpolator> interpolator = new SimpleObjectProperty<>(this, "interpolator", Interpolator.LINEAR);
