...
public class FoodCard extends VBox implements Initializable {
	...
	private Pane image;
	@FXML
	private Label price, quantityLabel;
	@FXML
	private RatingView rating;
	@FXML
	private JFXButton add, increase;
	@FXML
	private NodeSwitcher addToCartSwitcher;
	@FXML
	private Text total;
	@FXML
	private FakeFocus fakeFocus;
	
	private final ObjectProperty<Restaurant.Food> food = new SimpleObjectProperty<>(this, "food");
