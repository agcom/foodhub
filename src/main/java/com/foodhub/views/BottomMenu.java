...
public class BottomMenu {
    ...
    private ObservableList<BottomMenuItem> items = FXCollections.observableArrayList();
    private IntegerProperty selectedItemIndex = new SimpleIntegerProperty(this, "selectedItemIndex", 0); {
        ...
        selectedItemIndex.addListener((observable, oldValue, newValue) -> {
            ...
            if(newValue.equals(-1) && !oldValue.equals(-1)) { //deselect all
                ...
                if(!newValue.equals(-1)) {
                    ...
                    if(items.get(newValue.intValue()).getOnAction() != null) items.get(newValue.intValue()).getOnAction().run();
