...
public class HomeController implements Initializable {
	...
	@FXML
	private LoadingWrapper restaurantPageLoading;
	@FXML
	private ScrollPane restaurantPageScroll;
	@FXML
	private ScrollPane restaurantsScroll;
	@FXML
	private NodeSwitcher homeSwitcher;
	@FXML
	private VBox restaurants;
	@FXML
	private TilePane foods;
	@FXML
	private RestaurantCard restaurantCard;
	private Navigator navigator;
	private final Navigator rpNavigator = new Navigator();
	...
	private final Service<Void> restaurantPageUpdater = new Service<>() {
